    ...
    <div className="flex flex-col items-center mt-7">
      ...
      >
        ...
        <div className="m-6 hidden md:hidden lg:flex">
          ...
          {/* telephone */}
          <form style={{ width: "50%" }}>
            <label htmlFor="phone" className="text-[#4A5568] text-sm pb-2 block">
              Phone
            </label>
            <input
              type="number"
        ...
        <div className="m-6 lg:hidden">
          <form>
            <label htmlFor="email" className="text-[#4A5568] text-sm pb-2 block ">
              Email
            </label>
            <input
              type="email"
          ...
          <form>
            <label htmlFor="tele" className="text-[#4A5568] text-sm mt-6 pb-2 block">
              Telephone
            </label>
        ...
        <div className="m-6">
          <label htmlFor="timer" className="flex text-[#4A5568] text-sm pb-2">
            Interactive Timer
            <Tooltip title="Log me out if im inactive for this long" placement="bottom">
              <svg
          ...
          <div className="flex mt-6">
            ...
            <Tooltip title="Notify me when a payment schedule starts" placement="bottom">
              <svg
                className="ml-2 mt-1 w-[14px] h-[14px] cursor-pointer"
                width="12"
                height="12"
