...
const Security = () => {
  ...
  const Checkbox = () => {
    ...
    return (
      <label className="flex items-center mt-2 space-x-2">
        ...
        />
        <span className="text-[#4A5568] text-xs">Also enable 2FA for approvals</span>
      </label>
    );
  };
  ...
  return (
    <div className="flex flex-col items-center mt-7 mb-9 ">
      ...
      >
        <div className="m-6 ">
          <p className="text-[#4A5568] font-semibold text-[18px]">Change Password</p>
        ...
        <div className="m-6">
          <form>
            <label htmlFor="ccpassword" className="text-[#4A5568] text-sm pb-2 block">
              Current Password
            </label>
        ...
        <div className="m-6">
          <form>
            <label htmlFor="npassword" className="text-[#4A5568] text-sm pb-2 block">
              New password
            </label>
        ...
        <div className="m-6">
          <form>
            <label htmlFor="confirmpassword" className="text-[#4A5568] text-sm pb-2 block">
              Confirm Password
            </label>
      ...
      <div className="flex items-center mt-3  ">
        <p className="text-[#4A5568] text-sm">Activate 2 Factor Authentication</p>
        <Tooltip
      ...
      >
        <div className="lg:grid lg:grid-cols-2 m-6 ">
          <div>
            <p className="text-[#4A5568] font-normal text-lg mb-4">Enable 2FA</p>
          ...
          <div className="mt-9">
            <p className="text-[#4A5568] text-sm font-normal">
              In order to turn on 2FA, use your mobile Authenticator app to scan the code, then
              enter the six-digit code provided by the app in the form below.
            </p>
            {/* all those boxes */}
