    ...
    return (
      ...
      >
        <div className="flex justify-between items-center ">
          <h2 className="text-md  text-[#4A5568] mx-auto mb-2 font-semibold">Add New User</h2>
        ...
        {addusertextinput("Full Name", name, setName, "Enter Your Full Name", "full-name")}

        {/* #2 email adress */}
        {addusertextinput("Email Address", email, setEmail, "Enter Your Email Address", "emailll")}

        {/* #3 password */}
        {addusertextinput("Password", password, setPassword, "Enter Your Password", "pass-word")}
  ...
  return (
    <div>
      <div className="flex ml-auto justify-end items-center mx-2 px-[12px] mt-8 pb-5">
        <button
          className="bg-[#3B2774] h-[32px] w-[123px] font-[600] rounded text-center text-white text-sm gap-8"
          onClick={openModal}
        >
          Add New User
        </button>
