...
const Users = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: (row) => (
        <div className="text-[#1C065A]" style={{ opacity: row.status2 === "Reactivate" ? 0.5 : 1 }}>
          {row.email}
        </div>
      )
    },
  ...
  return (
    <div className="mx-5" style={{ border: "1px solid var(--Color-Gray-Gray-40, #CBD5E0)" }}>
      <DataTable columns={columns} data={data} />

      <EditUserModal isEditModalOpen={isEditModalOpen} closeEditModal={closeEditModal} />
