    ...
    <div>
      ...
      <Link to="/schedules/table">
        <div className="flex mx-3 md:mx-7 my-5 items-center">
          ...
          <p className="text-[14px] font-semibold mx-2 text-[#1C065A]">
            Schedules
            <span className="text-[#4A5568] font-normal">/ Schedule-detail (BLPSCID0013B31)</span>
          </p>
        </div>
      </Link>
      ...
      <div className="hidden md:hidden lg:block pb-7  col-span-2 bg-white lg:mx-7 md:mx-3">
        <div className="flex mx-3 md:mx-7 pt-6">
          <h5 className="text-[#1C065A] font-[500] text-[14px]">Chevron Salaries Staff Grade 1A</h5>
          <div className="flex ml-auto items-center " onClick={copyToClipboard}>
            <h5 className="font-light text-[14px] mr-4   text-[#4A5568]">Schedule Id</h5>
            <svg
        ...
        <div className="flex mx-7  ">
          <p className="text-[14px] font-light text-[#4A5568]">25 Beneficiaries</p>
          <p className="ml-auto text-[#1C065A] text-[14px] font-[500]">BLPSCOD0013B31</p>
        </div>
        <Toaster />
        ...
        <div className="mx-7  ">
          ...
          <div className="flex  text-[#718096] text-[12px] font-light lg:gap-[1.5rem] xl:gap-[5.5rem] pt-3">
            <div className="border-r-[1px] pr-[3.5rem] ">
              <div>DAY PAYABLE</div>
              <div className="text-[#1C065A] text-[12px] font-[500] pt-1">28th of the Month</div>
            </div>
            <div className="border-r-[1px] pr-[3.5rem]">
              <div>TIME PAYABLE</div>
              <div className="text-[#1C065A] text-[12px] font-[500] pt-1">12:00</div>
            </div>
            <div className="border-r-[1px] pr-[3.5rem]">
              <div>TOTAL PAYOUT</div>
              <div className="text-[#1C065A] text-[12px] font-[500] pt-1">N12.430,900.00</div>
            </div>
            <div className="border-r-[1px] pr-[3.5rem]">
              <div>CREATED ON</div>
              <div className="text-[#1C065A] text-[12px] font-[500] pt-1">12th September, 2023</div>
            </div>
            <div className="">
      ...
      <div className="md:block lg:hidden pb-7  block col-span-2 bg-white mx-3 lg:mx-7">
        <div className="mx-3 md:mx-7 pt-6">
          ...
          <div className="flex items-center " onClick={copyToClipboard}>
            <h5 className="font-light text-[14px] mr-2  text-[#4A5568]">Schedule Id</h5>
            <svg
        ...
        <div className="flex mx-3 md:mx-7 ">
          <p className=" text-[#1C065A] text-[14px] font-[500]">BLPSCOD0013B31</p>
        </div>
        <Toaster />
        ...
        <div className="mx-3 md:mx-7   ">
          ...
          <div className="sm:flex block mt-3 grid-cols-1 sm:grid-cols-2  text-[#718096] text-[12px] font-light  ">
            <div className="col-span-2 ">
              <p>DAY PAYABLE</p>
              <p className="text-[#1C065A] text-[12px] font-[500] pt-1">26th of the Month</p>
            </div>
            <div className="mt-3 sm:mt-0  ml-auto sm:mr-[4rem]">
              <p>TIME PAYABLE</p>
              <p className="text-[#1C065A] text-[12px] font-[500] pt-1">12:00</p>
            </div>
          </div>
          <div className="sm:flex block mt-3 grid-cols-1 sm:grid-cols-2  text-[#718096] text-[12px] font-light ">
            <div className="col-span-2">
              <p>DAY PAYOUT</p>
              <p className="text-[#1C065A] text-[12px] font-[500] pt-1">N12,430,900.00</p>
            </div>
            <div className="col-span-2 ml-auto mt-3 sm:mt-0 ">
              <p>CREATED ON</p>
              <p className="text-[#1C065A] text-[12px] font-[500] pt-1">12th of September, 2023.</p>
            </div>
          </div>
