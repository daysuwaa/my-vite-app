        ...
        <div className="lg:grid grid-cols-3">
          <div className="hidden md:block col-span-2 bg-white lg:mx-7 md:mx-3">
            ...
            <div className="flex mx-7  ">
              <p className="text-[14px] font-light text-[#4A5568]">{no_of_beneficiaries}</p>
              <p className="ml-auto text-[#1C065A] text-[14px] font-[500]">{sch_id}</p>
            </div>
            <Toaster />
            ...
            <div className="mx-7  ">
              ...
              <div className="flex">
                <p className="text-[#1C065A] text-[14px] font-[500]">{daypayable}</p>
                <p className="text-[#1C065A] text-[14px] font-[500] ml-auto ">{createdon}</p>
              </div>
              <div className="mt-3 ">
                <div className="flex">
                  <p className="text-[#718096] text-[14px] font-light">Time payable</p>
                  <p className="text-[#718096] text-[14px] font-light ml-auto mr-[3.9rem]">
                    Last Payment
                  </p>
                </div>
                <div className="flex">
                  <p className="text-[#1C065A] text-[14px] font-[500]">{timepayable}</p>
                  <p className="text-[#1C065A] text-[14px] font-[500] ml-auto ">{lastpayment}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="md:hidden block col-span-2 bg-white mx-3 lg:mx-7">
            ...
            <div className="mx-3  ">
              ...
              <div className="flex mt-3">
                <p className="text-[#718096] text-[14px] font-light">Day Payable</p>
                <p className="text-[#718096] text-[14px] font-light ml-auto mr-[4.8rem]">
                  Created On
                </p>
              </div>
          ...
          <div className="cols-span-1">
            ...
            <div className="grid-cols-2 grid-rows-6 mx-3  md:mx-10 lg:mx-5">
              <div className="flex mt-5">
                <p className="text-[#1C065A] text-[14px] font-[600] ">{monthly_salary}</p>
