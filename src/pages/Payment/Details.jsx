        ...
        <Link to="/payment">
          <div className="flex mx-3 md:mx-7 my-5 items-center">
            ...
            <p className="text-[14px] font-semibold mx-2 text-[#1C065A]">
              {tab}
              <span className="text-[#4A5568] font-normal">/ Payment-detail {schedule_detail}</span>
            </p>
          </div>
        </Link>
        ...
        <div>
          <div className="hidden md:block col-span-2 bg-white lg:mx-7 md:mx-3">
            ...
            <div className="flex mx-7  ">
              ...
              <p className="ml-auto text-[#1C065A] font-[500]">{transaction_no}</p>
            </div>

            <hr className="mx-3 h-[2px] border-b my-9 bg-[#CBD5E0]" />
            <div className="mx-7  ">
              <p className="text-[#1C065A] text-[10px] font-[500]">SCHEDULE DETAILS</p>
              <div className="flex mt-5">
                <p className="text-[#718096] text-[14px] font-light">Schedule ID</p>
                <p className="text-[#718096] text-[14px] font-light ml-auto mr-[6.3rem]">Paid On</p>
              </div>
              <div className="flex">
                <p className="text-[#1C065A] text-[14px] font-[500]">{schedule_id}</p>
                <p className="text-[#1C065A] text-[14px] font-[500] ml-auto ">{paidon}</p>
              </div>
              <div className="mt-3 ">
                <div className="flex">
                  <p className="text-[#718096] text-[14px] font-light">Schedule Name</p>
                  <p className="text-[#718096] text-[14px] font-light ml-auto mr-[3rem]">
                    Payment Status
                  </p>
                </div>
                <div className="flex">
                  <p className="text-[#1C065A] text-[14px] font-[500]">{schedulename}</p>
            ...
            <div className="mx-7 md:pb-7 lg:pb-0">
              <p className="font-thin text-[#718096] text-[12px]">Amount Paid</p>
              <p className="text-[#1C065A] text-[18px] font-semibold">{amount}</p>
              <div className="flex">
                <p className=" text-[#718096] text-[14px]">Beneficiary Bank:</p>
                <p className="text-[#1C065A] text-[14px] ml-1">{bank_details}</p>
              </div>
              <div className="flex">
                <p className=" text-[#718096] text-[14px]">Account Number:</p>
                <p className="text-[#1C065A] text-[14px] ml-1">{account_details}</p>
              </div>
          ...
          <div className="md:hidden block col-span-2 bg-white mx-3 lg:mx-7">
            <div className="mx-3 md:mx-7 pt-6">
              ...
              <div className=" items-center ">
                <h5 className="font-light text-[14px] text-[#4A5568]">Transaction Number</h5>
                <p className="ml-auto text-[#1C065A] font-[500]">{transaction_no}</p>
              </div>
            </div>
            {/* second line */}
            ...
            <div className="mx-3  ">
              ...
              <div className="flex mt-5">
                <p className="text-[#718096] text-[14px] font-light">Schedule ID</p>
                <p className="text-[#718096] text-[14px] font-light ml-auto mr-[6.2rem]">Paid On</p>
              </div>
              <div className="flex">
                <p className="text-[#1C065A] text-[14px] font-[500]">{schedule_id}</p>
                <p className="text-[#1C065A] text-[14px] font-[500] ml-auto ">{paidon}</p>
          ...
          <div className="cols-span-1 mt-4">
            ...
            <div className="flex mx-3 md:mx-7 items-center ">
              ...
              <Link to="/payment/recents" className="underline ml-auto text-[12px] text-[#4A5568]">
                View all
              </Link>
              <svg
                width="12"
            ...
            <div className="flex mx-3 md:mx-7 bg-[#EBE3FC] px-[16px] py-[12px] rounded mt-4">
              ...
              <p className="ml-auto text-[#1C065A] text-[14px] font-[600]">{total_paid}</p>
            </div>
            <div className="grid-cols-2 grid-rows-6 mx-3 md:mx-7 pb-7 lg:pb-0">
              <div className="flex mt-5">
                <p className="text-[#1C065A] text-[14px] font-[600] ">650,000.00</p>
                <p className="ml-auto text-[#718096] text-[14px] font-[300]">{date}</p>
              </div>
